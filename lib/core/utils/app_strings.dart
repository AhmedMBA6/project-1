abstract class AppStrings {
  static const String appName = "Museum",
  //!on Boarding strings
    skip = "Skip",
    next = "Next",
  ...
  //!Auth Strings
      ...
      password = "Password",
      iHaveAgreeTo = "I have agree to ",
      ourTermsAndCondition = "Our Terms and Condition",
      signUp = "Sign Up",
      signIn = "Sign In",
      ...
      forgotPasswordSubTitle = "Enter your registered email below to receive password reset instruction",

...
import 'package:first_project/features/auth/presentation/widgets/custom_sign_in_form.dart';
import 'package:first_project/features/auth/presentation/widgets/have_an_account_widget.dart';
import 'package:first_project/features/auth/presentation/widgets/welcome_banner.dart';
    ...
    return Scaffold(
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverToBoxAdapter(child: HaveAnAccountWidget(text1: AppStrings.dontHaveAnAccount, text2: AppStrings.signUp, onTap: () {

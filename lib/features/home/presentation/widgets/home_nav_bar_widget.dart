...
List<PersistentBottomNavBarItem> _navBarsItems() {
  return [
    ...
    PersistentBottomNavBarItem(icon: SvgPicture.asset(Assets.imagesShoppingCartActive),
        inactiveIcon: SvgPicture.asset(Assets.imagesShoppingCart)),
    PersistentBottomNavBarItem(icon: SvgPicture.asset(Assets.imagesPersonActive),

...
import 'package:first_project/core/widgets/custom_data_list_view.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Stack(clipBehavior: Clip.none, children:[Positioned(top: -52, right: 16, child: SvgPicture.asset(Assets.imagesDetails3)), CustomDataListView(dataList: warsList, routePath: "/warsDetailsView"),]),
